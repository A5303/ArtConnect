	...
	<div class="my_cart">
		...
		<div class="cart_items">
			<ol>
				...
				<li><img src="images/Mona Lisa.png" alt="Mayon Volcano" class="my_cart_items"> <span class="my_cart_items_title">Mayon Volcano</span> <span class="my_cart_items_price">Php 5000</span></li>
            </ol>
        </div>
	</div>
</div>	